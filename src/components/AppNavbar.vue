<template>
  <header class="fixed z-50 w-full">
    <div class="bg-base-50 z-10 text-xl uppercase text-zinc-800 shadow duration-300">
      <div class="content source-sans mx-auto flex w-full items-center justify-between py-4">
        <router-link
          class="open-sans text-primary-900 group my-auto flex items-center gap-2 font-bold"
          to="/"
        >
          <img
