...
<template>
  <footer class="px-4 divide-y bg-neutral-800 text-gray-100">
    <div
      ...
      <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
        ...
        <div class="space-y-3">
          ...
          <ul class="space-y-1">
            ...
            <li>
              <a rel="noopener noreferrer" href="#">Credits</a>
            </li>
          </ul>
        </div>
        <div class="space-y-3">
          ...
          <ul class="space-y-1">
            ...
            <li>
              <a rel="noopener noreferrer" href="#">Use my components</a>
            </li>
          </ul>
        </div>
        <div class="space-y-3">
    ...
    <div class="py-6 text-sm text-center">© 2024 Ralodev. Some rights reserved.</div>
  </footer>
</template>
